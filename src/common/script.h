...
typedef struct _EMCInterpreterCallbacks {
  ...
  void (*EMCInterpreterCallbacks_StartBackgroundAnimationPart)(
      EMCInterpreter *interp, uint16_t animIndex, uint16_t partIndex);
  ...
  void (*EMCInterpreterCallbacks_LoadMusicFile)(EMCInterpreter *interp,
                                                int fileNum);
  uint16_t (*EMCInterpreterCallbacks_PlayMusicTrack)(EMCInterpreter *interp,
                                                     int track);
  ...
  int (*EMCInterpreterCallbacks_InitMonster)(EMCInterpreter *interp,
                                             uint16_t block, uint16_t xOff,
                                             uint16_t yOff, uint16_t facing,
