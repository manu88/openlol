CCFLAGS= -g `pkg-config --cflags sdl2` `pkg-config --cflags sdl2_image` `pkg-config --cflags sdl2_ttf` -Wpedantic -Wall -MD -fsanitize=address -Isrc/common -Isrc/game -Isrc/dbg
